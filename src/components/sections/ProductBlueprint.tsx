        ...
        <div className="grid gap-12 lg:grid-cols-[0.92fr_1.08fr]">
          <div>
            ...
            <h2 className="mt-4 text-balance text-4xl font-semibold text-white md:text-5xl">
              iReViajes es el caso que demuestra que la solución ya existe.
            </h2>
            <p className="mt-5 max-w-xl text-base leading-8 text-white/72">
              El trabajo ahora no es inventar otra cosa. Es convertir esa base en una oferta
              clara para otras agencias, con modulos, mensajes, proceso comercial y despliegue
              por fases.
            </p>
