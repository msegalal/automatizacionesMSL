    ...
    <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-6">
      <div>
        ...
        <h2 className="mt-3 text-3xl font-semibold text-slate-950">
          Cuéntame qué quieres vender y qué parte quieres automatizar.
        </h2>
      </div>
      ...
      <div aria-live="polite">
        {status === "success" ? (
          <div className="rounded-[1.4rem] border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-900">
            Solicitud recibida. Te responderé con un planteamiento inicial.
          </div>
        ) : null}
        {status === "error" ? (
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div>
          ...
          >
            ...
            <option value="producto">Producto / packaging</option>
        ...
        <div className="md:col-span-2">
          ...
          <textarea
            id="mensaje"
            rows={6}
            placeholder="Qué producto tienes hoy, a quién quieres vendérselo y dónde se rompe ahora mismo la parte comercial u operativa."
            {...register("mensaje")}
